...
import EditorFloatingActions from '../components/EditorFloatingActions';
import { connectToStore } from 'components/StoreContext';
import history from 'store/history';

class EditorFloatingActionsContainer extends React.Component {
  _handleHelp = () => {
...
export default connectToStore(observer(EditorFloatingActionsContainer));
